...
dropout_per=0.7
'''
DATA->Convolution->Subsampling->Convolution->Subsampling->\
...
layer_1=tf.nn.dropout(layer_1, keep_prob=dropout_per)
#Layer_2
...
layer_2=tf.nn.dropout(layer_2, keep_prob=dropout_per)
#layer_2---> 7x7x64
